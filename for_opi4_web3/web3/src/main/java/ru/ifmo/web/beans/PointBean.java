...
import ru.ifmo.web.monitoring.MonitoringRegistry;
...
public class PointBean implements Serializable {
    ...
    public void checkPoint() {
        ...
        boolean saved = resultHistoryBean.addResult(result);
        if (saved) {
            MonitoringRegistry.recordAttempt(resultHistoryBean.getSessionId(), hit);
        }
    ...
    public void setR(double r) {
        this.r = r;
        MonitoringRegistry.updateRadius(r);
    }
